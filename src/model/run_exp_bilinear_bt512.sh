...
python -m src.model.cluster_dist_transformer_original \
  ...
  --pos_exist \
  --use_type_embed \
  --loss_type recall_focused_loss > logs_bilinear_bt512/recall_focused_loss.log 2>&1
...
python -m src.model.cluster_dist_transformer_original \
  ...
  --pos_exist \
  --use_type_embed \
  --loss_type kld_reverse > logs_bilinear_bt512/kld_reverse.log 2>&1
...
python -m src.model.cluster_dist_transformer_original \
  ...
  --pos_exist \
  --use_type_embed \
  --loss_type mse > logs_bilinear_bt512/mse.log 2>&1
...
python -m src.model.cluster_dist_transformer_original \
  ...
  --pos_exist \
  --use_type_embed \
  --loss_type hybrid > logs_bilinear_bt512/hybrid.log 2>&1
