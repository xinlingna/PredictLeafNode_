...
# 创建日志目录
mkdir -p logs_bilinear_bt512_ug

# ===== 设置实验标识符 =====
EXPERIMENT_ID="E"  # 您可以根据需要修改这个标识符
...
python -m src.model.cluster_dist_transformer_original \
  ...
  --use_gating \
  --use_type_embed \
  --loss_type recall_focused_loss > logs_bilinear_bt512_ug/recall_focused_loss.log 2>&1
...
python -m src.model.cluster_dist_transformer_original \
  ...
  --use_gating \
  --use_type_embed \
  --loss_type kld > logs_bilinear_bt512_ug/kld.log 2>&1
...
python -m src.model.cluster_dist_transformer_original \
  ...
  --use_gating \
  --use_type_embed \
  --loss_type kld_reverse > logs_bilinear_bt512_ug/kld_reverse.log 2>&1
...
python -m src.model.cluster_dist_transformer_original \
  ...
  --use_gating \
  --use_type_embed \
  --loss_type mse > logs_bilinear_bt512_ug/mse.log 2>&1
...
python -m src.model.cluster_dist_transformer_original \
  ...
  --use_gating \
  --use_type_embed \
  --loss_type hybrid > logs_bilinear_bt512_ug/hybrid.log 2>&1
...
python -m src.model.cluster_dist_transformer_original \
  ...
  --loss_type listnet > logs_bilinear_bt512_ug/listnet.log 2>&1
...
python -m src.model.cluster_dist_transformer_original \
  ...
  --pair_num_neg 15 \
  --pair_margin 0.2 \
  --loss_type pairwise_hinge > logs_bilinear_bt512_ug/pairwise_hinge.log 2>&1
...
python -m src.model.cluster_dist_transformer_original \
  ...
  --use_type_embed \
  --listmle_topm 20 \
  --loss_type listmle > logs_bilinear_bt512_ug/listmle.log 2>&1
