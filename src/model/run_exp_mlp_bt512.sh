...
python -m src.model.cluster_dist_transformer_original \
  ...
  --log_interval 10 \
  --pos_exist \
  --loss_type kld > logs_mlp_bt512/kld.log 2>&1
...
python -m src.model.cluster_dist_transformer_original \
  ...
  --log_interval 10 \
  --pos_exist \
  --loss_type kld_reverse > logs_mlp_bt512/kld_reverse.log 2>&1
...
python -m src.model.cluster_dist_transformer_original \
  ...
  --log_interval 10 \
  --pos_exist \
  --loss_type recall_focused_loss > logs_mlp_bt512/recall_focused_loss.log 2>&1
...
python -m src.model.cluster_dist_transformer_original \
  ...
  --log_interval 10 \
  --pos_exist \
  --loss_type mse > logs_mlp_bt512/mse.log 2>&1
...
python -m src.model.cluster_dist_transformer_original \
  ...
  --log_interval 10 \
  --pos_exist \
  --loss_type hybrid > logs_mlp_bt512/hybrid.log 2>&1
