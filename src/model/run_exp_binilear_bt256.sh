...
python -m src.model.cluster_dist_transformer_original \
  ...
  --pos_exist \
  --use_gating \
  --loss_type kld > logs_bilinear_bt256/kld.log 2>&1
...
python -m src.model.cluster_dist_transformer_original \
  ...
  --pos_exist \
  --use_gating \
  --loss_type kld_reverse > logs_bilinear_bt256/kld_reverse.log 2>&1
...
python -m src.model.cluster_dist_transformer_original \
  ...
  --pos_exist \
  --use_gating \
  --loss_type recall_focused_loss > logs_bilinear_bt256/recall_focused_loss.log 2>&1
...
python -m src.model.cluster_dist_transformer_original \
  ...
  --pos_exist \
  --use_gating \
  --loss_type mse > logs_bilinear_bt256/mse.log 2>&1
...
python -m src.model.cluster_dist_transformer_original \
  ...
  --pos_exist \
  --use_gating \
  --loss_type hybrid > logs_bilinear_bt256/hybrid.log 2>&1
